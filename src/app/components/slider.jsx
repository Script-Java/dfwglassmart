    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-black/50 z-10 flex flex-col justify-center items-center text-center px-4">
        <h2 className="text-white text-4xl md:text-6xl font-bold mb-4">
          Trusted Glass Repair & Replacement in Dallas
        </h2>
        <p className="text-white text-lg md:text-xl mb-6 max-w-2xl">
          With over 21 years of experience, DFW Glass Mart delivers fast, affordable, and expert glass solutions for vehicles and homes across Dallas and surrounding areas.
        </p>
        <Link className="btn btn-primary p-4 " href={'/quote'}>GET A QUOTE TODAY</Link>
      </div>
    </div>
  );
};
